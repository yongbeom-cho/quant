...
function App() {
    ...
    const addIndicator = (category) => {
        ...
        if (category === 'ma') setIndicators([...indicators, { ...base, type: 'sma', period: '20', color: '#f2ff00' }]);
        else if (category === 'bb') setIndicators([...indicators, { ...base, type: 'bollinger', period: '20', color: '#2196F3' }]);
        else if (category === 'ichi') setIndicators([...indicators, { ...base, type: 'ichimoku', period: '9,26,52', color: '#9C27B0' }]);
    };
        ...
        <div style={containerStyle}>
            <div style={leftSidebarStyle}>
                ...
                <div style={addBtnGroup}>
                    <button onClick={() => addIndicator('ma')} style={addBtnStyle}>MA</button>
                    <button onClick={() => addIndicator('bb')} style={addBtnStyle}>BB</button>
                    <button onClick={() => addIndicator('ichi')} style={addBtnStyle}>ICHI</button>
                </div>
...
const addBtnGroup = { display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '4px', marginBottom: '15px' };
